...
"    return %0 : !torch.list<int>\n"
"  }\n"
"  func.func @\"__torch_mlir_shape_fn.aten.einsum\"(%arg0: !torch.str, %arg1: !torch.list<list<int>>, %arg2: !torch.optional<list<int>>) -> !torch.list<int> {\n"
"    %str = torch.constant.str \"\"\n"
"    %true = torch.constant.bool true\n"
"    %str_0 = torch.constant.str \",\"\n"
"    %int-1 = torch.constant.int -1\n"
"    %str_1 = torch.constant.str \"->\"\n"
"    %str_2 = torch.constant.str \"AssertionError: \"\n"
"    %none = torch.constant.none\n"
"    %int2 = torch.constant.int 2\n"
"    %int0 = torch.constant.int 0\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %1 = torch.operator \"aten.split.str\"(%arg0, %str_1, %int-1) : (!torch.str, !torch.str, !torch.int) -> !torch.list<str>\n"
"    %2 = torch.aten.len.t %1 : !torch.list<str> -> !torch.int\n"
"    %3 = torch.aten.eq.int %2, %int2 : !torch.int, !torch.int -> !torch.bool\n"
"    torch.prim.If %3 -> () {\n"
"      torch.prim.If.yield\n"
"    } else {\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %4 = torch.aten.__getitem__.t %1, %int0 : !torch.list<str>, !torch.int -> !torch.str\n"
"    %5 = torch.operator \"aten.split.str\"(%4, %str_0, %int-1) : (!torch.str, !torch.str, !torch.int) -> !torch.list<str>\n"
"    %6 = torch.prim.ListConstruct  : () -> !torch.list<bool>\n"
"    %7 = torch.aten.len.t %5 : !torch.list<str> -> !torch.int\n"
"    torch.prim.Loop %7, %true, init() {\n"
"    ^bb0(%arg3: !torch.int):\n"
"      %21 = torch.aten.__getitem__.t %5, %arg3 : !torch.list<str>, !torch.int -> !torch.str\n"
"      %22 = torch.operator \"aten.isalpha\"(%21) : (!torch.str) -> !torch.bool\n"
"      %23 = torch.aten.append.t %6, %22 : !torch.list<bool>, !torch.bool -> !torch.list<bool>\n"
"      torch.prim.Loop.condition %true, iter()\n"
"    } : (!torch.int, !torch.bool) -> ()\n"
"    %8 = torch.aten.all.bool %6 : !torch.list<bool> -> !torch.bool\n"
"    torch.prim.If %8 -> () {\n"
"      torch.prim.If.yield\n"
"    } else {\n"
"      torch.prim.RaiseException %str_2, %none : !torch.str, !torch.none\n"
"      torch.prim.If.yield\n"
"    }\n"
"    %9 = torch.aten.__getitem__.t %1, %int1 : !torch.list<str>, !torch.int -> !torch.str\n"
"    %10 = torch.operator \"aten.isalpha\"(%9) : (!torch.str) -> !torch.bool\n"
"    torch.prim.If %10 -> () {\n"
"      torch.prim.If.yield\n"
"    } else {\n"
"      torch.prim.RaiseException %str_2, %none : !torch.str, !torch.none\n"
"      torch.prim.If.yield\n"
"    }\n"
"    %11 = torch.prim.DictConstruct keys(%str : !torch.str) values(%int0 : !torch.int) -> !torch.dict<str, int>\n"
"    %12 = torch.aten.len.t %5 : !torch.list<str> -> !torch.int\n"
"    %13 = torch.aten.len.t %arg1 : !torch.list<list<int>> -> !torch.int\n"
"    %14 = torch.aten.eq.int %12, %13 : !torch.int, !torch.int -> !torch.bool\n"
"    torch.prim.If %14 -> () {\n"
"      torch.prim.If.yield\n"
"    } else {\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %15 = torch.aten.len.t %5 : !torch.list<str> -> !torch.int\n"
"    %16 = torch.aten.len.t %arg1 : !torch.list<list<int>> -> !torch.int\n"
"    %17 = torch.prim.ListConstruct %15, %16 : (!torch.int, !torch.int) -> !torch.list<int>\n"
"    %18 = torch.prim.min.self_int %17 : !torch.list<int> -> !torch.int\n"
"    torch.prim.Loop %18, %true, init() {\n"
"    ^bb0(%arg3: !torch.int):\n"
"      %21 = torch.aten.__getitem__.t %5, %arg3 : !torch.list<str>, !torch.int -> !torch.str\n"
"      %22 = torch.aten.__getitem__.t %arg1, %arg3 : !torch.list<list<int>>, !torch.int -> !torch.list<int>\n"
"      %23 = torch.aten.len.str %21 : !torch.str -> !torch.int\n"
"      %24 = torch.aten.len.t %22 : !torch.list<int> -> !torch.int\n"
"      %25 = torch.aten.eq.int %23, %24 : !torch.int, !torch.int -> !torch.bool\n"
"      torch.prim.If %25 -> () {\n"
"        torch.prim.If.yield\n"
"      } else {\n"
...
"        torch.prim.If.yield\n"
"      }\n"
"      %26 = torch.aten.len.str %21 : !torch.str -> !torch.int\n"
"      %27 = torch.aten.len.t %22 : !torch.list<int> -> !torch.int\n"
"      %28 = torch.prim.ListConstruct %26, %27 : (!torch.int, !torch.int) -> !torch.list<int>\n"
"      %29 = torch.prim.min.self_int %28 : !torch.list<int> -> !torch.int\n"
"      torch.prim.Loop %29, %true, init() {\n"
"      ^bb0(%arg4: !torch.int):\n"
"        %30 = torch.operator \"aten.__getitem__.str\"(%21, %arg4) : (!torch.str, !torch.int) -> !torch.str\n"
"        %31 = torch.aten.__getitem__.t %22, %arg4 : !torch.list<int>, !torch.int -> !torch.int\n"
"        %32 = torch.aten.__contains__.str %11, %30 : !torch.dict<str, int>, !torch.str -> !torch.bool\n"
"        torch.prim.If %32 -> () {\n"
"          %33 = torch.aten.__getitem__.Dict_str %11, %30 : !torch.dict<str, int>, !torch.str -> !torch.int\n"
"          %34 = torch.aten.eq.int %33, %31 : !torch.int, !torch.int -> !torch.bool\n"
"          torch.prim.If %34 -> () {\n"
"            torch.prim.If.yield\n"
"          } else {\n"
"            torch.prim.RaiseException %str_2, %none : !torch.str, !torch.none\n"
...
"          torch.prim.If.yield\n"
"        } else {\n"
"          torch.aten._set_item.str %11, %30, %31 : !torch.dict<str, int>, !torch.str, !torch.int\n"
"          torch.prim.If.yield\n"
"        }\n"
"        torch.prim.Loop.condition %true, iter()\n"
"      } : (!torch.int, !torch.bool) -> ()\n"
...
"    %20 = torch.aten.len.str %9 : !torch.str -> !torch.int\n"
"    torch.prim.Loop %20, %true, init() {\n"
"    ^bb0(%arg3: !torch.int):\n"
"      %21 = torch.operator \"aten.__getitem__.str\"(%9, %arg3) : (!torch.str, !torch.int) -> !torch.str\n"
"      %22 = torch.aten.__getitem__.Dict_str %11, %21 : !torch.dict<str, int>, !torch.str -> !torch.int\n"
"      %23 = torch.aten.append.t %19, %22 : !torch.list<int>, !torch.int -> !torch.list<int>\n"
"      torch.prim.Loop.condition %true, iter()\n"
"    } : (!torch.int, !torch.bool) -> ()\n"
"    return %19 : !torch.list<int>\n"
"  }\n"
"  func.func @\"__torch_mlir_shape_fn.aten.unsafe_chunk\"(%arg0: !torch.list<int>, %arg1: !torch.int, %arg2: !torch.int) -> !torch.list<list<int>> {\n"
"    %int-1 = torch.constant.int -1\n"
"    %true = torch.constant.bool true\n"
"    %none = torch.constant.none\n"
"    %str = torch.constant.str \"AssertionError: \"\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %2 = call @__torch__.torch.jit._shape_functions.maybe_wrap_dim(%arg2, %0, %true) : (!torch.int, !torch.int, !torch.bool) -> !torch.int\n"
"    %3 = torch.aten.__getitem__.t %arg0, %2 : !torch.list<int>, !torch.int -> !torch.int\n"
"    %4 = torch.aten.gt.int %arg1, %int0 : !torch.int, !torch.int -> !torch.bool\n"
"    torch.prim.If %4 -> () {\n"
"      torch.prim.If.yield\n"
"    } else {\n"
"      torch.prim.RaiseException %str, %none : !torch.str, !torch.none\n"
"      torch.prim.If.yield\n"
"    }\n"
"    %5 = torch.aten.neg.int %arg1 : !torch.int -> !torch.int\n"
"    %6 = torch.aten.floordiv.int %3, %5 : !torch.int, !torch.int -> !torch.int\n"
"    %7 = torch.aten.neg.int %6 : !torch.int -> !torch.int\n"
"    %8 = torch.prim.max.int %int1, %7 : !torch.int, !torch.int -> !torch.int\n"
"    %9 = torch.aten.remainder.int %3, %8 : !torch.int, !torch.int -> !torch.int\n"
"    %10 = call @__torch__.torch.jit._shape_functions._copy(%arg0) : (!torch.list<int>) -> !torch.list<int>\n"
"    %11 = torch.prim.ListConstruct %10 : (!torch.list<int>) -> !torch.list<list<int>>\n"
"    %12 = torch.aten.__getitem__.t %11, %int0 : !torch.list<list<int>>, !torch.int -> !torch.list<int>\n"
"    %13 = torch.aten._set_item.t %12, %2, %8 : !torch.list<int>, !torch.int, !torch.int -> !torch.list<int>\n"
"    %14 = torch.aten.neg.int %8 : !torch.int -> !torch.int\n"
"    %15 = torch.aten.floordiv.int %3, %14 : !torch.int, !torch.int -> !torch.int\n"
"    %16 = torch.aten.neg.int %15 : !torch.int -> !torch.int\n"
"    %17 = torch.operator \"aten.mul_.t\"(%11, %16) : (!torch.list<list<int>>, !torch.int) -> !torch.list<list<int>>\n"
"    %18 = torch.aten.Bool.int %9 : !torch.int -> !torch.bool\n"
"    torch.prim.If %18 -> () {\n"
"      %19 = torch.aten.__getitem__.t %17, %int-1 : !torch.list<list<int>>, !torch.int -> !torch.list<int>\n"
"      %20 = torch.aten._set_item.t %19, %2, %9 : !torch.list<int>, !torch.int, !torch.int -> !torch.list<int>\n"
"      torch.prim.If.yield\n"
"    } else {\n"
"      torch.prim.If.yield\n"
"    }\n"
"    return %17 : !torch.list<list<int>>\n"
"  }\n"
